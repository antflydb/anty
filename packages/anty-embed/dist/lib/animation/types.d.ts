 ...
 */
export type EmotionType = 'happy' | 'sad' | 'angry' | 'shocked' | 'excited' | 'celebrate' | 'pleased' | 'spin' | 'jump' | 'idea' | 'back-forth' | 'look-around' | 'wink' | 'nod' | 'headshake' | 'look-left' | 'look-right' | 'super' | 'smize';
/**
 ...
 */
export type SearchMode = 'inactive' | 'focusing' | 'active' | 'searching' | 'results' | 'closing';
/**
 * Animation easing functions
 */
export type EasingFunction = 'linear' | 'ease' | 'ease-in' | 'ease-out' | 'ease-in-out' | 'cubic-bezier' | 'spring' | 'bounce' | 'power1.in' | 'power1.out' | 'power1.inOut' | 'power2.in' | 'power2.out' | 'power2.inOut' | 'power3.in' | 'power3.out' | 'power3.inOut' | 'power4.in' | 'power4.out' | 'power4.inOut' | 'back.in' | 'back.out' | 'back.inOut' | 'elastic.in' | 'elastic.out' | 'elastic.inOut';
/**
...
export interface AnimationEvent {
    /** Event type */
    type: 'stateChange' | 'emotionStart' | 'emotionEnd' | 'transitionStart' | 'transitionEnd' | 'error' | 'queueUpdate' | 'pause' | 'resume' | 'metricsUpdate';
    /** Event timestamp */
    timestamp: number;
    /** Event payload */
    payload: {
 ...
 */
export declare function isEmotionType(value: string): value is EmotionType;
/**
 * Type guard to check if a value is a valid animation state
 */
export declare function isAnimationState(value: string): value is AnimationState;
/**
 * Type guard to check if a value is a valid search mode
 */
export declare function isSearchMode(value: string): value is SearchMode;
/**
 ...
 */
export declare const DEFAULT_SEARCH_BAR_CONFIG: SearchBarConfig;
