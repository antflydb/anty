          ...
          <div className="w-full max-w-[450px] flex flex-col gap-8">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <Label htmlFor="name" className="text-[14px] font-semibold text-[#1A1A23]">
                  Full Name
                </Label>
                <Input
                  id="name"
                  ...
                  required
                  className="h-[52px] rounded-[12px] border-[1.5px] border-[#ADB4B7]/30 focus-visible:border-[#1A1A23] focus-visible:ring-0 focus-visible:ring-offset-0"
                />
              </div>

              {/* Email Field */}
              <div className="flex flex-col gap-2">
                <Label htmlFor="email" className="text-[14px] font-semibold text-[#1A1A23]">
                  Email
                </Label>
                <Input
                  id="email"
              ...
              <Button
                type="submit"
                className="h-[56px] rounded-full bg-[#1A1A23] hover:bg-[#1A1A23]/90 text-white font-semibold text-[16px] mt-2"
                style={{ fontFamily: 'SF Pro, sans-serif' }}
              >
                Continue
              </Button>
