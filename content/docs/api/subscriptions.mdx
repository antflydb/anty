...
response = requests.post('https://searchaf.antfly.io/api/v1/organizations/{org_id}/subscription', headers=headers)
...
func main() {
    req, _ := http.NewRequest("POST", "https://searchaf.antfly.io/api/v1/organizations/{org_id}/subscription", nil)
    req.Header.Set("Authorization", "Bearer YOUR_API_KEY")
...
response = requests.patch('https://searchaf.antfly.io/api/v1/organizations/{org_id}/subscription', headers=headers)
...
func main() {
    req, _ := http.NewRequest("PATCH", "https://searchaf.antfly.io/api/v1/organizations/{org_id}/subscription", nil)
    req.Header.Set("Authorization", "Bearer YOUR_API_KEY")
...
response = requests.post('https://searchaf.antfly.io/api/v1/organizations/{org_id}/subscription/portal', headers=headers)
...
func main() {
    req, _ := http.NewRequest("POST", "https://searchaf.antfly.io/api/v1/organizations/{org_id}/subscription/portal", nil)
    req.Header.Set("Authorization", "Bearer YOUR_API_KEY")
