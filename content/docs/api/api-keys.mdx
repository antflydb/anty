...
response = requests.post('https://searchaf.antfly.io/api/v1/projects/{project_id}/api-keys', headers=headers)
...
func main() {
    req, _ := http.NewRequest("POST", "https://searchaf.antfly.io/api/v1/projects/{project_id}/api-keys", nil)
    req.Header.Set("Authorization", "Bearer YOUR_API_KEY")
